...
export default function ProductForm({ errors, file, onFileSelect, product, update , onModalInfo, onPrev, onUpdateProduct}: ProductFormProps) {
        ...
        <div className="space-y-6 w-full overflow-hidden">
            ...
            <form className="space-y-5 px-2" onSubmit={onSubmit}>
                <div className="overflow-y-auto max-h-[70vh] flex flex-col gap-2">
                    ...
                    <ImageInput error={errors.imageUrl} file={file} onFileSelect={onFileSelect} currentImageUrl={product.imageUrl}/>
